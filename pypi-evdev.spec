...
Version  : 1.9.1
Release  : 49
URL      : https://files.pythonhosted.org/packages/d1/99/4d24bb6db12fc170a5f209f4c9108054a2c84d289d1e7f743e979b202023/evdev-1.9.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/d1/99/4d24bb6db12fc170a5f209f4c9108054a2c84d289d1e7f743e979b202023/evdev-1.9.1.tar.gz
...
%prep
%setup -q -n evdev-1.9.1
cd %{_builddir}/evdev-1.9.1
pushd ..
cp -a evdev-1.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740411232
