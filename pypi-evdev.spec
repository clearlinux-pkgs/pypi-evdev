...
Version  : 1.8.0
Release  : 46
URL      : https://files.pythonhosted.org/packages/4c/eb/b8900082a13a47bb9f69f415174d03cbf12ce95d07345722e1f4ef0e2093/evdev-1.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/4c/eb/b8900082a13a47bb9f69f415174d03cbf12ce95d07345722e1f4ef0e2093/evdev-1.8.0.tar.gz
...
%prep
%setup -q -n evdev-1.8.0
cd %{_builddir}/evdev-1.8.0
pushd ..
cp -a evdev-1.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738008125
