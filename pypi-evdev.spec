...
Source0  : https://files.pythonhosted.org/packages/63/fe/a17c106a1f4061ce83f04d14bcedcfb2c38c7793ea56bfb906a6fadae8cb/evdev-1.9.2.tar.gz
...
%prep
%setup -q -n evdev-1.9.2
cd %{_builddir}/evdev-1.9.2
pushd ..
cp -a evdev-1.9.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746196207
